        ...
        <div class="card-body">
          ...
          if($detail->status_pembayaran=='belum_dibayar'){
            if($detail->jenis_pembayaran=='cash'){
              ...
              <div class="alert alert-danger" role="alert">
                <h4 class="alert-heading">Silahkan lakukan pembayaran</h4>
                <p class="mb-0">Untuk menyelesaikan pembayaran ini, transfer sejumlah <b><?=rupiah($detail->total_bayar)?></b> ke Rekening 142820103 (BNI) / 1201390124444 (BRI).<br>
          ...
          ?>
              <div class="alert alert-warning" role="alert">
                ...
                <p class="mb-0">Bukti transfer anda sudah kami terima dan sedang dalam tahap verifikasi, silahkan cek halaman ini secara bekala, terimakasih.</p>
              </div>
            <hr>
          <?php
          ...
          ?>
              <div class="alert alert-success" role="alert">
                ...
                <p class="mb-0">Silahkan tunjukan halaman ini kepada resepsionis apartemen/hotel untuk mendapatkan kunci kamar anda.</p>
              </div>
