      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="number" name="harga_minggu" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Harga per Minggu" required>
          </div>
          <div class="form-group">
