    ...
    <div class="col-md-12" style="margin-top: 60px;">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label for="exampleInputEmail1">Harga per Minggu</label>
            <input type="number" name="harga_minggu" value="<?=$detail->harga_minggu?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Harga per Minggu" required>
          </div>
          <div class="form-group">
