  ...
  <div class="row">
    <div class="col-md-12" style="margin-top: 60px;">
      <div class="card">
        ...
        <div class="card-body">
          <a href="<?=base_url('apartement/add')?>" class="btn btn-primary">Tambah Data Penginapan</a>
          <hr>
          ...
          <table class="table">
            <thead class="thead-dark">
              <tr>
                ...
                <th scope="col">Harga per Hari/Minggu/Bulan</th>
            ...
            <tbody>
              ...
              foreach($list as $l){
                ...
                <tr>
                  ...
                  <td><?=$l->nama_kota?></td>
                  <td><?=rupiah($l->harga)?> / <?=rupiah($l->harga_minggu)?> / <?=rupiah($l->harga_bulan)?></td>
