      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-3">
              <span class="text-purple text-bold">Nama Penginapan</span><br>
              <?=$detail->nama_apartemen?>
            </div>
            <div class="col-md-6">
              <span class="text-purple text-bold">Harga per Hari / Minggu /Bulan</span><br>
              <?=rupiah($detail->harga)?> /
              <?=rupiah($detail->harga_minggu)?> /
          ...
          <?=$this->session->flashdata('message')?>
            <div class="form-group">
              ...
              <select name="paket" id="sPaket" onchange="tJumlah()" class="form-control" required>
                ...
                <?php 
                $paket = array('harian','mingguan','bulanan');
                foreach($paket as $p){
